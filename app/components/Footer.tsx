    ...
    <footer className="border-t border-zinc-200 dark:border-zinc-800 mt-32">
      <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-md bg-zinc-900 dark:bg-zinc-800 flex items-center justify-center">
          ...
          <span className="text-lg font-bold text-zinc-900 dark:text-zinc-100">MochiLinux</span>
        </div>
