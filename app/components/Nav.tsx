...
const links = [
  ...
  { label: "CLI", href: "#cli-applications" },
  { label: "Init System", href: "#custom-init-system" },
  { label: "Why Mochi?", href: "#why-mochilinux" },
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800">
      <nav className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-md bg-zinc-900 dark:bg-zinc-800 flex items-center justify-center shrink-0">
            <Image src="/logo.svg" alt="MochiLinux logo" width={20} height={20} priority />
          </div>
